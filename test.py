...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        icons = [("icons/upload.svg",""),("icons/sensor.svg",""),("icons/settings.svg",""),("icons/plant.svg",""),("icons/weather.svg",""),("icons/play.svg",""),("icons/key.svg",""),("icons/record.svg","")]
        for path,_ in icons:
            btn = IconButton(path, "")
        ...
        # Controls
        ctr = QHBoxLayout()
        combo = QComboBox(); combo.addItems(["C","D","E","F","G","A","B"]);
    ...
    def apply_styles(self):
        self.setStyleSheet("""
            ...
            QLabel{color:#e0e0e0;}
            QComboBox{background:#1a1a2e;color:#e0e0e0;border:1px solid #3b3b5e;border-radius:4px;}
        """)
